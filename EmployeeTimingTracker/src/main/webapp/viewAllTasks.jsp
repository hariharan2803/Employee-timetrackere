...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #2e3b4e, #1c1f26); /* Dark gradient background */
            margin: 0;
            padding: 0;
            display: flex;
        ...
        .container {
            background: linear-gradient(135deg, #3a4a6a, #2a3a4a); /* Slightly darker gradient for the container */
            padding: 30px;
            border-radius: 12px;
        ...
        th {
            background: linear-gradient(135deg, #ff6f61, #de64a3); /* Gradient header background */
            color: #fff;
        }
        a {
